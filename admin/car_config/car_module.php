...
WHERE TimeCarConfirmed IS NULL AND Status = 0;
";
                ...
                ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="car_approve.php?CarID=<?= $row['CarID'] ?>&UserID=<?= $row['UserID'] ?>" class="btn btn-success"> Approve </a>
                                <a href="car_reject.php?CarID=<?= $row['CarID'] ?>&UserID=<?= $row['UserID'] ?>" class="btn btn-danger"> Reject </a>
