...
INNER JOIN userinfo
ON passengerinfo.UserID = userinfo.UserID
WHERE IDtype = 'driver' AND TimeConfirmed IS NULL AND IDstatus = 0;
";
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td class="text-center"> <?= $row['IDtype'] ?> </td>
                            <td class="text-center"> <?= $row['ValidIDNum'] ?> </td>
                            <td class="text-center">
                                <a href="id_approve.php?PassengerID=<?= $row['PassengerID'] ?>" class="btn btn-success"> Approve </a>
                                <a href="id_reject.php?PassengerID=<?= $row['PassengerID'] ?>" class="btn btn-danger"> Reject </a>
                            </td>
