                ...
                ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="approval.php?EMoneyID=<?= $row['EMoneyID'] ?>&UserID=<?= $row['UserID'] ?>&Amount=<?= $row['Amount'] ?>"  class="btn btn-success"> Approve </a>
                                <a href="rejection.php?EMoneyID=<?= $row['EMoneyID'] ?>&UserID=<?= $row['UserID'] ?>" class="btn btn-danger"> Reject </a>
