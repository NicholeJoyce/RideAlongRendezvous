...
<body style="background: linear-gradient(to bottom left, #B0E0E6 10%, #BD1088 100%)">
    ...
    <div class="container my-3 col-lg-5">
        ...
        <form action="../config/dcashout.php" method="post">

            <h1 class="mb-3"> Cash Out Page </h1>
            <hr>
            ...
            <div class="row">
                <div class="mb-3 col-5">
                    <label for="contact_no" class="form-label">GCash Number</label>
                    <input type="number" required name="gcash" id="gcash" class="form-control">
                </div>

                <div class="row">
                    <div class="mb-3 col-5">
                        <label for="contact_no" class="form-label">Amount to Cash Out</label>
                        <input type="number" required name="cashout" id="cashout" class="form-control" min="1">
                    </div>

                    <div class="row">
                        <div class="col">
                            <input type="submit" name="register" value="Cash Out" class="btn btn-primary" style="background-color:#161B30">
